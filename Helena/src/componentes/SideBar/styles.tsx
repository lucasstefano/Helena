...
export const NavItem = styled.div<NavItemProps>`
  ...
  margin-bottom: 4px;
  cursor: pointer;
  color: ${props => props.active ? '#2563eb' : '#4b5563'}; /* Azul */
  background-color: ${props => props.active ? '#dbeafe' : 'transparent'}; /* Azul claro */
  
  &:hover {
    background-color: ${props => props.active ? '#dbeafe' : '#f9fafb'}; /* Azul claro */
  }
`;
